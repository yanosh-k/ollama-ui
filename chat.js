...
window.onload = () => {
    ...
    document.getElementById('import-chat-file').addEventListener('change', handleChatImport);
...
function exportChat() {
    ...
    var jsonData = JSON.stringify({"history": history, "context": context, "model": model});
...
function importChat() {
    document.getElementById('import-chat-file').click();
